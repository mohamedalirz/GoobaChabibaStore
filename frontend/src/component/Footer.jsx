  ...
  return (
    <footer className="footer-container">
      <div className="footer-content">
        <h2>About Gooba Brand</h2>
        <p>
          Gooba Brand is the official merchandise store of the streamer Gooba.
          Shop exclusive t-shirts, hoodies, caps, and scarves to support your
          favorite streamer in style!
        </p>
        <p>
          Quality, comfort, and style — all crafted for Gooba fans.
        </p>
        ...
        <div className="footer-bottom">
          <p>
            &copy; 2026 Gooba Brand. All Rights Reserved. Powered by Devign</p>
          <img
            src="/devign.png" 
            alt="Devign Logo"
